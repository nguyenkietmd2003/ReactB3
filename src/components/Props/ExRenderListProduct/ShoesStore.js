...
export default class ShoesStore extends Component {
  ...
  // Hàm mở modal và thiết lập thông tin sản phẩm
  ...
  // Hàm đóng modal
  closeModal = () => {
    this.setState({ showModal: false, productDetail: null });
  };
  ...
  render() {
    return (
      <div className="container">
        <h3>Shoe shop</h3>
        <ListProductItem
          dataShoeList={dataListShoe}
          setStateModal={this.setStateModal} // Truyền hàm setStateModal xuống component con
        />
